...
from kxns_cli.llm import LLM, ModelCapability
...
from kxns_cli.wire.types import TurnBegin
...
def _make_soul(
    ...
    return KxnsSoul(agent, context=context), context


async def _run_and_collect_turns(
    soul: KxnsSoul, user_input: str | list[ContentPart]
