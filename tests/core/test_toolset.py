"""Tests for KxnsToolset hide/unhide functionality."""
...
from kxns_cli.wire.types import ToolCall, ToolResult
...
def _tool_names(ts: KxnsToolset) -> set[str]:
