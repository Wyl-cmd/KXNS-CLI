...
from kxns_cli.skill import Skill
from kxns_cli.skill.flow import Flow, FlowEdge, FlowNode
...
def test_flow_skill_registers_skill_and_flow_commands(runtime: Runtime, tmp_path: Path) -> None:
    ...
    soul = KxnsSoul(agent, context=Context(file_backend=tmp_path / "history.jsonl"))
