...
from kxns_cli.wire.file import WireMessageRecord
from kxns_cli.wire.serde import deserialize_wire_message, serialize_wire_message
    ...
    assert serialize_wire_message(msg) == snapshot(
        {
            ...
            "payload": {
                ...
                "token_usage": None,
                "message_id": None, "plan_mode": None, "thinking": None, "model": None},
        }
    )
    _test_serde(msg)
                ...
                "questions": [
                    {
                        ...
                        "multi_select": False, "body": "", "other_label": "", "other_description": ""}
                ],
            },
        }
    )
...
def test_wire_message_type_alias():
    import kxns_cli.wire.types

    module = kxns_cli.wire.types
...
def test_read_wire_lines_request_id(tmp_path: Path):
    ...
    from kxns_cli.web.api.sessions import _read_wire_lines
