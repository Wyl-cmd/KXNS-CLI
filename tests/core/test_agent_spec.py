...
from kxns_cli.agentspec import DEFAULT_AGENT_FILE, load_agent_spec
from kxns_cli.exception import AgentSpecError
...
def test_load_default_agent_spec():
    ...
    assert spec.tools == snapshot(
        [
            "kxns_cli.tools.multiagent:Task", "kxns_cli.tools.think:Think", "kxns_cli.tools.ask_user:AskUserQuestion",
            "kxns_cli.tools.todo:SetTodoList",
            "kxns_cli.tools.shell:Shell",
            "kxns_cli.tools.file:ReadFile",
            "kxns_cli.tools.file:ReadMediaFile",
            "kxns_cli.tools.file:Glob",
            "kxns_cli.tools.file:Grep",
            "kxns_cli.tools.file:WriteFile",
            "kxns_cli.tools.file:StrReplaceFile",
            "kxns_cli.tools.web:SearchWeb",
            "kxns_cli.tools.web:FetchURL", "kxns_cli.tools.plan:ExitPlanMode", "kxns_cli.tools.plan.enter:EnterPlanMode"]
    )
    subagents = {
    ...
    assert subagent_specs["coder"].exclude_tools == snapshot(
        [
            "kxns_cli.tools.multiagent:Task",
            "kxns_cli.tools.multiagent:CreateSubagent",
            "kxns_cli.tools.dmail:SendDMail",
            "kxns_cli.tools.todo:SetTodoList",
        ]
    )
...
def test_load_agent_spec_basic(agent_file: Path):
    ...
    assert spec.tools == snapshot(["kxns_cli.tools.think:Think"])
...
def test_load_agent_spec_with_exclude_tools(agent_file_with_tools: Path):
    ...
    assert spec.tools == snapshot(["kxns_cli.tools.think:Think", "kxns_cli.tools.shell:Shell"])
    assert spec.exclude_tools == snapshot(["kxns_cli.tools.shell:Shell"])
...
""")
        ...
        assert spec.exclude_tools == snapshot(
            ["kxns_cli.tools.web:SearchWeb", "kxns_cli.tools.web:FetchURL"]
        )
...
agent:
  ...
  tools: ["kxns_cli.tools.think:Think"]
""")
...
agent:
  name: "Test Agent"
  system_prompt_path: ./system.md
  tools: ["kxns_cli.tools.think:Think", "kxns_cli.tools.shell:Shell"]
  exclude_tools: ["kxns_cli.tools.shell:Shell"]
""")
