...
from kxns_cli.config import Config, WebSearchConfig, get_default_config
from kxns_cli.llm import ALL_MODEL_CAPABILITIES, LLM
from kxns_cli.metadata import WorkDirMeta
from kxns_cli.session import Session
from kxns_cli.session_state import SessionState
from kxns_cli.soul.agent import Agent, BuiltinSystemPromptArgs, LaborMarket, Runtime
from kxns_cli.soul.approval import Approval
from kxns_cli.soul.denwarenji import DenwaRenji
from kxns_cli.soul.toolset import KxnsToolset
from kxns_cli.tools.dmail import SendDMail
from kxns_cli.tools.file.glob import Glob
from kxns_cli.tools.file.grep_local import Grep
from kxns_cli.tools.file.read import ReadFile
from kxns_cli.tools.file.read_media import ReadMediaFile
from kxns_cli.tools.file.replace import StrReplaceFile
from kxns_cli.tools.file.write import WriteFile
from kxns_cli.tools.multiagent.create import CreateSubagent
from kxns_cli.tools.multiagent.task import Task
from kxns_cli.tools.shell import Shell
from kxns_cli.tools.think import Think
from kxns_cli.tools.todo import SetTodoList
from kxns_cli.tools.web.fetch import FetchURL
from kxns_cli.tools.web.search import SearchWeb
from kxns_cli.utils.environment import Environment
...
def config() -> Config:
    ...
    conf.services.web_search = WebSearchConfig(
        base_url="https://api.kxns.com/coding/v1/search",
...
def builtin_args(temp_work_dir: KaosPath) -> BuiltinSystemPromptArgs:
    ...
    return BuiltinSystemPromptArgs(
        KXNS_NOW="1970-01-01T00:00:00+00:00",
        KXNS_WORK_DIR=temp_work_dir,
        KXNS_WORK_DIR_LS="Test ls content",
        KXNS_AGENTS_MD="Test agents content",
        KXNS_SKILLS="No skills found.",
...
def tool_call_context(tool_name: str) -> Generator[None]:
    ...
    from kxns_cli.soul.toolset import current_tool_call
    from kxns_cli.wire.types import ToolCall
...
@pytest.fixture
def create_subagent_tool(toolset: KxnsToolset, runtime: Runtime) -> CreateSubagent:
