...
LLM friendly version: https://github.com/Wyl-cmd/KXNS-CLI/llms.txt""",
    add_completion=False,
    context_settings={"help_option_names": ["-h", "--help"]},
    help="KXNS, your next CLI agent.",
)
...
def kimi(
    ...
    acp_mode: Annotated[
        ...
        typer.Option(
            "--acp",
            help="(Deprecated, use `kxns acp` instead) Run as ACP server.",
        ),
    ] = False,
    wire_mode: Annotated[
        bool,
