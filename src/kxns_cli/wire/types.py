...
from kxns_cli.tools.display import (
    DiffDisplayBlock,
    ShellDisplayBlock,
    TodoDisplayBlock,
    TodoDisplayItem,
)
from kxns_cli.utils.typing import flatten_union
...
class StatusUpdate(BaseModel):
    ...
    """Whether thinking mode is enabled. None means no change."""
    model: str | None = None
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `kxns_cli.soul.approval.Request`, but
