...
from kxns_cli.wire.serde import serialize_wire_message
...
class JSONRPCSetThinkingMessage(_MessageBase):
    class Params(BaseModel):
        enabled: bool

    method: Literal["set_thinking"] = "set_thinking"
    id: str
    params: Params


class JSONRPCSetModelMessage(_MessageBase):
    class Params(BaseModel):
        model: str

    method: Literal["set_model"] = "set_model"
    id: str
    params: Params
...
JSONRPC_IN_METHODS = {"initialize", "prompt", "steer", "replay", "cancel", "set_plan_mode", "set_thinking", "set_model"}
