...
from kxns_cli.soul import StatusSnapshot, format_context_status
from kxns_cli.ui.shell.console import console
from kxns_cli.utils.clipboard import grab_image_from_clipboard, is_clipboard_available
from kxns_cli.utils.logging import logger
from kxns_cli.utils.media_tags import wrap_media_part
from kxns_cli.utils.slashcmd import SlashCommand
from kxns_cli.utils.string import random_string
from kxns_cli.wire.types import ContentPart, ImageURLPart, TextPart
...
def get_user_prompt() -> str:
    """Get user prompt with username@current_directory format."""
    import os
    ...
    if cwd == os.path.expanduser("~"):
        cwd = "~"
    elif cwd.startswith(os.path.expanduser("~")):
...
class AttachmentCache:
    def __init__(self, root: Path | None = None) -> None:
        self._root = root or Path("/tmp/kxns")
...
class CustomPromptSession:
    ...
    def _render_message(self) -> FormattedText:
        ...
        return FormattedText([("bold cyan", f"{user_prompt}"), ("", f"{symbol} ")])
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from kxns_cli.utils.editor import edit_text_in_editor, get_editor_command
