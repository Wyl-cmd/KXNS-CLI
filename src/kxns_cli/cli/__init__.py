...
def _save_api_config(
    ...
    thinking_str = f"\ndefault_thinking = true" if thinking else ""

    config_content = f'''# Kxns Hunter CLI Configuration
# Generated by kxns api command

default_model = "{model}"{thinking_str}

[models.{model}]
provider = "custom"
model = "{model}"
max_context_size = {max_context_size}{capabilities_str}
...
'''
    ...
    if thinking:
        typer.echo(f"  Thinking Mode: enabled")
