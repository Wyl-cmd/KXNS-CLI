"""Kxns Hunter CLI Web UI application."""
...
from kxns_cli.web.api import (
    config_router,
    open_in_router,
    sessions_router,
    work_dirs_router,
)
from kxns_cli.web.auth import (
...
ENV_SESSION_TOKEN = "KXNS_WEB_SESSION_TOKEN"
ENV_ALLOWED_ORIGINS = "KXNS_WEB_ALLOWED_ORIGINS"
ENV_ENFORCE_ORIGIN = "KXNS_WEB_ENFORCE_ORIGIN"
ENV_RESTRICT_SENSITIVE_APIS = "KXNS_WEB_RESTRICT_SENSITIVE_APIS"
ENV_MAX_PUBLIC_PATH_DEPTH = "KXNS_WEB_MAX_PUBLIC_PATH_DEPTH"
...
ENV_LAN_ONLY = "KXNS_WEB_LAN_ONLY"
...
def create_app(
    ...
    """Create the FastAPI application for Kxns Hunter CLI web UI."""
    ...
    application = FastAPI(
        title="Kxns Hunter CLI Web Interface",
        docs_url=None,
        lifespan=lifespan,
