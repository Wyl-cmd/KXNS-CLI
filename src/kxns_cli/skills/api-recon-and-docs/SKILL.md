...
| Finding | Next Skill |
|---|---|
| object IDs everywhere | [hunt-idor](../hunt-idor/SKILL.md) |
| JWT, OAuth, role claims | [api auth and jwt abuse](../jwt-attack/SKILL.md) |
| GraphQL or hidden fields | [hunt-graphql](../hunt-graphql/SKILL.md) |
