...
## Advanced Technical Reference (from idor-playbook)
...
**Key distinction**: BOLA = accessing **object** you shouldn't own (other users' data); BFLA = accessing **function** you shouldn't be authorized for (admin CRUD, bulk actions, user management).

### BFLA (Function Level) Attacks
...
How to discover hidden admin endpoints:
...
5. Compare regular user vs admin section docs if available

### ORM Filter Chain Leaks
