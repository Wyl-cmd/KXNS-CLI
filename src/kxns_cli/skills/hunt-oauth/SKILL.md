...
## OIDC-Specific Misconfiguration Checks

When the target uses OpenID Connect (OIDC) layered on OAuth 2.0, these checks extend the standard OAuth hunting methodology:
