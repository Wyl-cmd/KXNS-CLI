...
### Phase 6 — jku / x5u Header Injection
...
### Phase 7 — Token Triage & Hidden Field Abuse
...
- jku/x5u injection: Server MUST fetch the attacker-controlled JWKS/cert URL and accept tokens signed with attacker's key.
