...
class AskUserQuestion(CallableTool2[Params]):
    ...
    def __init__(self) -> None:
        ...
        self._cached_plan_mode: bool = False
        self._base_desc: str = self.description

    def bind_plan_mode(self, checker: Callable[[], bool]) -> None:
    ...
    def base(self):
        if self._plan_mode_checker is not None:
            ...
            if in_plan != self._cached_plan_mode:
                ...
                desc = self._base_desc + _PLAN_MODE_SUFFIX if in_plan else self._base_desc
