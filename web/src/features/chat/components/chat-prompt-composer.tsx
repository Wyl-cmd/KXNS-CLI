      ...
      >
        ...
        <PromptInputFooter className="w-full gap-2 py-1 border-none bg-transparent shadow-none">
          <PromptInputTools className="flex-1 min-w-0 flex-wrap">
            <GlobalConfigControls planMode={planMode} onPlanModeChange={onPlanModeChange} thinking={thinking} onThinkingChange={onThinkingChange} sessionModel={sessionModel} onSessionModelChange={onSessionModelChange} />
          </PromptInputTools>
          {isStreaming ? (
