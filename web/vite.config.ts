...
function readKxnsCliVersion(): string {
  const fallback = process.env.KXNS_CLI_VERSION ?? "dev";
...
const kxnsCliVersion = readKxnsCliVersion();
...
export default defineConfig({
  ...
  define: {
    __KXNS_CLI_VERSION__: JSON.stringify(kxnsCliVersion),
  },
  resolve: {
    alias: {
