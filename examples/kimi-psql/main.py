...
from kxns_cli.llm import LLM, create_llm
from kxns_cli.session import Session
from kxns_cli.soul import LLMNotSet, LLMNotSupported, MaxStepsReached, RunCancelled, run_soul
from kxns_cli.soul.agent import Runtime
from kxns_cli.soul.context import Context
from kxns_cli.soul.kimisoul import KimiSoul
from kxns_cli.ui.shell.visualize import visualize
from kxns_cli.wire.types import StatusUpdate
...
async def create_psql_soul(llm: LLM | None, conninfo: str) -> KimiSoul:
    ...
    from kxns_cli.soul.agent import load_agent
    from kxns_cli.soul.toolset import KimiToolset
