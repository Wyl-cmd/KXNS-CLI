...
class OpenAILegacy:
    ...
    def with_thinking(self, effort: ThinkingEffort) -> Self:
        ...
        if effort == "off":
            ...
            new_self._reasoning_key = None
        else:
            new_self._reasoning_effort = thinking_effort_to_reasoning_effort(effort)
            if new_self._reasoning_key is None:
                new_self._reasoning_key = new_self._original_reasoning_key
        return new_self
        ...
        for part in message.content:
            if isinstance(part, ThinkPart):
                if self._reasoning_key:
                    ...
                    content.append(TextPart(text=part.think))
            else:
                content.append(part)
